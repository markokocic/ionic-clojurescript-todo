...
* [`src/iotodo/`](src/iotodo/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/iotodo/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `iotodo` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/iotodo/config.cljs) defaults to `true` in
...
```clj
(ns iotodo.example
  (:require [iotodo.config :as config])
